    ...
    二封筒問題のシミュレーション
    (Created: 2020-11-02, Time-stamp: <2020-11-05T11:58:35Z>)
...
> あなたはゲームのプレイヤーです。胴元が、二の見分けのつかない封筒を提
> 示して、こう言います。「どちらか一方を取ってください。それぞれ金額の
> 書かれた小切手が入っっていて、取った方の金額を差し上げますよ。ちなみ
...
なわち得をする機械を見逃さないのが、a <= X/3 という基準であると言えそ
うだ。
